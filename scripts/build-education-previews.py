...
for key,spec in EDUCATION_VARIANTS.items():
 template=build_education_variant(key)
 suffix={'classroom-nature':'scene_left_3','classroom-story':'cards_3','training-case':'cards_4','training-action':'cards_3'}[key]
