...
import { TemplateBuilder, TemplateLibrary } from "./features/templates/TemplateWorkspace";
import "./styles.css";
...
function App() {
  ...
  if (location.pathname === "/templates") return <TemplateLibrary />;
  if (location.pathname === "/templates/new") return <TemplateBuilder />;
