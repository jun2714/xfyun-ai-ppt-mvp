...
export const ELEMENT_INSERT_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "vector-line-arrow", label: "空心右箭头" },
      { id: "vector-line-arrow-left", label: "空心左箭头" },
      { id: "vector-line-arrow-up", label: "空心上箭头" },
      { id: "vector-line-arrow-down", label: "空心下箭头" },
      { id: "vector-arrowhead-filled-right", label: "实心右箭头" },
      { id: "vector-arrowhead-filled-left", label: "实心左箭头" },
      { id: "vector-arrowhead-filled-up", label: "实心上箭头" },
      { id: "vector-arrowhead-filled-down", label: "实心下箭头" },
    ],
  },
  {
    label: "块状箭头",
    items: [
      ...
      { id: "vector-chevron-right", label: "双箭头" },
      { id: "vector-notched-arrow", label: "缺口箭头" },
      { id: "vector-bent-arrow", label: "折角箭头" },
