...
const exportRoot = __dirname;
const packageJson = JSON.parse(
  fs.readFileSync(path.join(exportRoot, "package.json"), "utf8"),
);

const targetRoot = path.join(exportRoot, "runtime");
